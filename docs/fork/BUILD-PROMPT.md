...
- Do not touch `C:\Users\Patrick\OS` except: reading files the plan names, reading `.env` values for the build environment (never print them), and adding the port 8342 row to `meta/PORTS.md` in Phase 12.
